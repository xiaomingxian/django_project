    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alive', models.SmallIntegerField(choices=[(0, '未激活'), (1, '激活')], default=1, verbose_name='激活标志')),
                ('authority', models.SmallIntegerField(choices=[(0, '无权限'), (1, '有权限')], default=1, verbose_name='权限')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isDefault', models.SmallIntegerField(choices=[(0, '否'), (1, '是')], default=0, verbose_name='是否默认')),
